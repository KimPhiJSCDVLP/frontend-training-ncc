...
export default function ProfileSettingsStickyNav() {
    return (
        <>
                    ...
                    <div className="sticky-navbar-container">
                                ...
                                <div className="navbar-menu-wrapper">
                                    ...
                                    <li className="account">
                                        ...
                                        <div className="account-menu-dropdown">
                                            <div className="account-menu">Profile Settings</div>
                        ...
                        <div className="the-rest">
                            ...
                            <div className="account">
                                <img src="https://cartzilla.createx.studio/img/nft/vendor/avatar-sm.png" alt="" />
                            </div>
                            <div className="btn-create-account">Create</div>
                        </div>
                    </div>
                </div>
            </div>
