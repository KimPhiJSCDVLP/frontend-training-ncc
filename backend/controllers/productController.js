...
module.exports.getAllProduct = async (req, res) => {
  db.query(
    `SELECT p.id, p.title, p.image, p.price, p.quantity,p.description,
              c.title as category FROM products p JOIN categories c ON
                  c.id = p.cat_id`,
    (err, results) => {
      if (err) console.log(err);
...
module.exports.getProductById = async (req, res) => {
  ...
  db.query(
    `SELECT p.id, p.title, p.image, p.description, p.price, p.quantity,
          c.title as category FROM products p JOIN categories c ON
...
module.exports.addProduct = async (req, res) => {
  ...
  db.query(
    `INSERT INTO products (title, image, description, price, quantity, cat_id)
